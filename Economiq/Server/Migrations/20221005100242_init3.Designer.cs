...
namespace Economiq.Server.Migrations
{
    ...
    [Migration("20221005100242_init3")]
    partial class init3
    {
            ...
            modelBuilder.Entity("Economiq.Shared.Models.Expense", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CategoryNavId = 2,
                            Comment = "Glass",
                            CreationDate = new DateTime(2022, 10, 5, 12, 2, 42, 323, DateTimeKind.Local).AddTicks(7933),
                            ExpenseDate = new DateTime(2022, 10, 5, 0, 0, 0, 0, DateTimeKind.Local),
                            UserNavId = 1
                        });
                });
            ...
            modelBuilder.Entity("Economiq.Shared.Models.ExpenseCategory", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CategoryName = "Rent",
                            CreationDate = new DateTime(2022, 10, 5, 12, 2, 42, 323, DateTimeKind.Local).AddTicks(7884)
                        },
                        new
                        {
                            Id = 2,
                            CategoryName = "Food",
                            CreationDate = new DateTime(2022, 10, 5, 12, 2, 42, 323, DateTimeKind.Local).AddTicks(7887)
                        },
                        new
                        {
                            Id = 3,
                            CategoryName = "Transport",
                            CreationDate = new DateTime(2022, 10, 5, 12, 2, 42, 323, DateTimeKind.Local).AddTicks(7890)
                        },
                        new
                        {
                            Id = 4,
                            CategoryName = "Clothing",
                            CreationDate = new DateTime(2022, 10, 5, 12, 2, 42, 323, DateTimeKind.Local).AddTicks(7892)
                        },
                        new
                        {
                            Id = 5,
                            CategoryName = "Entertainment",
                            CreationDate = new DateTime(2022, 10, 5, 12, 2, 42, 323, DateTimeKind.Local).AddTicks(7894)
                        });
                });
            ...
            modelBuilder.Entity("Economiq.Shared.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            City = "Orebro",
                            CreationDate = new DateTime(2022, 10, 5, 12, 2, 42, 323, DateTimeKind.Local).AddTicks(7406),
                            Fname = "Julia",
                            Gender = "Female",
                            IsLoggedIn = false,
                            Lname = "Hook",
                        ...
                        new
                        {
                            Id = 2,
                            City = "Orebro",
                            CreationDate = new DateTime(2022, 10, 5, 12, 2, 42, 323, DateTimeKind.Local).AddTicks(7683),
                            Fname = "Alexander",
                            Gender = "Male",
                            IsLoggedIn = false,
                            Lname = "Volonen",
                        ...
                        new
                        {
                            Id = 3,
                            City = "Orebro",
                            CreationDate = new DateTime(2022, 10, 5, 12, 2, 42, 323, DateTimeKind.Local).AddTicks(7686),
                            Fname = "Stefan",
                            Gender = "Male",
                            IsLoggedIn = false,
                            Lname = "Krakowsky",
                        ...
                        new
                        {
                            Id = 4,
                            City = "Orebro",
                            CreationDate = new DateTime(2022, 10, 5, 12, 2, 42, 323, DateTimeKind.Local).AddTicks(7689),
                            Fname = "Winnie",
                            Gender = "Female",
                            IsLoggedIn = false,
                            Lname = "Huynh",
                        ...
                        new
                        {
                            Id = 5,
                            City = "Orebro",
                            CreationDate = new DateTime(2022, 10, 5, 12, 2, 42, 323, DateTimeKind.Local).AddTicks(7691),
                            Fname = "Eric",
                            Gender = "Male",
                            IsLoggedIn = false,
                            Lname = "Flodin",
                        ...
                        new
                        {
                            Id = 6,
                            City = "Fjugesta",
                            CreationDate = new DateTime(2022, 10, 5, 12, 2, 42, 323, DateTimeKind.Local).AddTicks(7693),
                            Fname = "Anders",
                            Gender = "Male",
                            IsLoggedIn = false,
                            Lname = "Bergstrom",
                        ...
                        new
                        {
                            Id = 7,
                            City = "Orebro",
                            CreationDate = new DateTime(2022, 10, 5, 12, 2, 42, 323, DateTimeKind.Local).AddTicks(7696),
                            Fname = "Peter",
                            Gender = "Male",
                            IsLoggedIn = false,
                            Lname = "Hafid",
                        ...
                        new
                        {
                            Id = 8,
                            City = "Orebro",
                            CreationDate = new DateTime(2022, 10, 5, 12, 2, 42, 323, DateTimeKind.Local).AddTicks(7698),
                            Fname = "admin",
                            Gender = "Male",
                            IsLoggedIn = false,
                            Lname = "admin",
